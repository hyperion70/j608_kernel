...
#if 0 /* Do not do infra DCM ON/OFF here due to H/W limitation. Do it on*/
...
static const char *dcm_name[NR_DCMS] = {
    ...
    "MJC_DCM",
        ...
        volatile unsigned int infra_globalcon_dcmctl,infra_globalcon_dcmdbc;
        volatile unsigned int infra_globalcon_dcmsel;
    ...
    mutex_unlock(&dcm_lock);
{
        ...
        printk("[IFR_DCM]INFRA_GLOBALCON_DCMCTL(0x%08x)\n", infra_globalcon_dcmctl);

        printk("[IFR_DCM]INFRA_GLOBALCON_DCMDBC(0x%08x)\n", infra_globalcon_dcmdbc);

        printk("[IFR_DCM]INFRA_GLOBALCON_DCMSEL(0x%08x)\n", infra_globalcon_dcmsel);
}
    p += sprintf(p, "\n********** dcm_state help *********\n");
    ...
    p += sprintf(p, "infra_globalcon_dcmctl=(0x%08x)\n",infra_globalcon_dcmctl);
    p += sprintf(p, "infra_globalcon_dcmdbc=(0x%08x)\n",infra_globalcon_dcmdbc);
    p += sprintf(p, "infra_globalcon_dcmsel=(0x%08x)\n",infra_globalcon_dcmsel);
