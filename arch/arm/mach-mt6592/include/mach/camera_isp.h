...
//Sensor IF IRQ
// SENIF IRQ : 0x1500_8014
#define SENIF_OVERRUN_IRQ_EN           ((unsigned int)1 << 0)
#define SENIF_CRCERR_IRQ               ((unsigned int)1 << 1)
#define SENIF_FSMERR_IRQ_EN            ((unsigned int)1 << 2)
#define SENIF_VSIZEERR_IRQ_EN          ((unsigned int)1 << 3)
#define SENIF_HSIZEERR_IRQ_EN          ((unsigned int)1 << 4)
#define SENIF_SENSOR_VSIZEERR_IRQ_EN   ((unsigned int)1 << 5)
#define SENIF_SENSOR_HSIZEERR_IRQ_EN   ((unsigned int)1 << 6)
//CSI2 : 0x1500_8108 SENINF1_CSI2
#define CSI_CRC_ERR_IRQ             ((unsigned int)1 << 0)
#define CSI_ECC_ERR_IRQ             ((unsigned int)1 << 1)
#define CSI_ECC_CORRECT_IRQ         ((unsigned int)1 << 2)
#define CSI_CSI2SYNC_NONSYNC_IRQ    ((unsigned int)1 << 3)
//NCSI2 : 0x1500_8614 SENIFN1_NCSI2
#define NCSI_ERR_FRAME_SYNC          ((unsigned int)1 << 0)
#define NCSI_ERR_ID                  ((unsigned int)1 << 1)
#define NCSI_ERR_ECC_NO_ERROR        ((unsigned int)1 << 2)
#define NCSI_ERR_ECC_CORRECTED       ((unsigned int)1 << 3)
#define NCSI_ERR_ECC_DOUBLE          ((unsigned int)1 << 4)
#define NCSI_ERR_CRC                 ((unsigned int)1 << 5)
#define NCSI_ERR_AFIFO               ((unsigned int)1 << 6)
#define NCSI_ERR_MULTI_LANE_SYNC     ((unsigned int)1 << 7)
#define NCSI_ERR_SOT_SYNC_HS_LNRD0   ((unsigned int)1 << 8)
#define NCSI_ERR_SOT_SYNC_HS_LNRD1   ((unsigned int)1 << 9)
#define NCSI_ERR_SOT_SYNC_HS_LNRD2   ((unsigned int)1 << 10)
#define NCSI_ERR_SOT_SYNC_HS_LNRD3   ((unsigned int)1 << 11)
#define NCSI_FS                      ((unsigned int)1 << 12)
#define NCSI_LS                      ((unsigned int)1 << 13)
#define NCSI_GS                      ((unsigned int)1 << 14)
...
typedef enum
{
    ...
    ISP_CMD_CLK_OD_EN,      // For ISP CLOCK Overdrive enable
...
#define ISP_READ_REGISTER   _IOR(ISP_MAGIC, ISP_CMD_READ_REG,      ISP_REG_IO_STRUCT)
...
#define ISP_CLK_OD_EN        _IOW  (ISP_MAGIC, ISP_CMD_CLK_OD_EN,unsigned long) //For ISP CLOCK Overdrive enable
