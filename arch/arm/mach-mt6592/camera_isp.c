...
#define DBG_SOF_DUMP_ERR    (1)
#if DBG_SOF_DUMP_ERR == 1
static MINT32 g_intx_err_stat = 0;
static MINT32 g_intx_dma_err_stat = 0;
#endif
...
static __tcmfunc irqreturn_t ISP_Irq(MINT32  Irq, MVOID *DeviceId)
{
   ...
   // MUINT32 senifIntStA = 0, regVal = 0;
    ...
    #if DBG_SOF_DUMP_ERR == 1
    statx_err       = ISP_RD32((void *)ISP_REG_ADDR_INT_STATUSX);
    statx_dma_err   = ISP_RD32((void *)ISP_REG_ADDR_DMA_INTX);
    g_intx_err_stat     |= statx_err;
    g_intx_dma_err_stat |= statx_dma_err;
    IrqStatus[ISP_IRQ_TYPE_INTX] = (statx_err & (g_IspInfo.IrqInfo.Mask[ISP_IRQ_TYPE_INTX] | g_IspInfo.IrqInfo.ErrMask[ISP_IRQ_TYPE_INTX]));
    IrqStatus[ISP_IRQ_TYPE_DMAX] = (statx_dma_err & (g_IspInfo.IrqInfo.Mask[ISP_IRQ_TYPE_DMAX] | g_IspInfo.IrqInfo.ErrMask[ISP_IRQ_TYPE_DMAX]));
    #else
    IrqStatus[ISP_IRQ_TYPE_INTX] = (ISP_RD32((void *)ISP_REG_ADDR_INT_STATUSX) & (g_IspInfo.IrqInfo.Mask[ISP_IRQ_TYPE_INTX] | g_IspInfo.IrqInfo.ErrMask[ISP_IRQ_TYPE_INTX]));
    IrqStatus[ISP_IRQ_TYPE_DMAX] = (ISP_RD32((void *)ISP_REG_ADDR_DMA_INTX)    & (g_IspInfo.IrqInfo.Mask[ISP_IRQ_TYPE_DMAX] | g_IspInfo.IrqInfo.ErrMask[ISP_IRQ_TYPE_DMAX]));
    #endif
    ...
    if(IrqStatus[ISP_IRQ_TYPE_INT] & ISP_IRQ_INT_STATUS_SOF1_INT_ST)
    {
        ...
        #if DBG_SOF_DUMP_ERR == 1
        LOG_DBG("P1_SOF_%d(0x%08lx,0x%08lx,0x%08x,0x%08x,0x%08x,0x%08x)",((ISP_RD32(ISP_REG_ADDR_TG_INTER_ST)&0x00FF0000)>>16),
                imgo_fbc.Reg_val, img2o_fbc.Reg_val, imgo_pa, img2o_pa, g_intx_err_stat, g_intx_dma_err_stat);
        g_intx_err_stat     = 0;
        g_intx_dma_err_stat = 0;
        #else
