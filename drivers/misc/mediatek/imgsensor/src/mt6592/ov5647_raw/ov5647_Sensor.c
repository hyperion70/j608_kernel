...
#define OV5647_TAG	"[ov5647]"

/* when enable this, capture mode is the same to preview mode*/
#define CAPTURE_USE_PREVIEW 0

#ifdef OV5647_DEBUG
#define SENSORDB(x, args...) pr_debug(OV5647_TAG x, ##args)
#else
#define SENSORDB(x, args...)
#endif
//#define ACDK
...
UINT32 OV5647SetMaxFrameRate(UINT16 u2FrameRate)
{
	...
	//dummy_line = OV5647_sensor.pclk / u2FrameRate / OV5647_PV_PERIOD_PIXEL_NUMS - OV5647_PV_PERIOD_LINE_NUMS;
        SENSORDB("10*OV5647_sensor.pclk= %d, u2FrameRate = %d,OV5647_sensor.line_length = %d\n", (10 * OV5647_sensor.pclk), u2FrameRate, OV5647_sensor.line_length);
	...
	//}
	SENSORDB("FrameHeight = %d, dummy_line = %d, OV5647_PV_PERIOD_LINE_NUMS = %d, OV5647_FULL_PERIOD_LINE_NUMS = %d\n",FrameHeight,dummy_line,OV5647_PV_PERIOD_LINE_NUMS,OV5647_FULL_PERIOD_LINE_NUMS);
...
/*No Need to implement this function*/
	...
	SENSORDB("[soso][OV5647_night_mode]enable=%d",enable);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
   ...
   SENSORDB("[%s]\n",__FUNCTION__);
	...
	//SENSORDB("[soso][OV5647Preview]shutter=%x,shutter=%d\n",OV5647_sensor.shutter,OV5647_sensor.shutter);
...
#endif
SENSORDB("[soso][capture]shutter=%x",shutter);
...
{
#if CAPTURE_USE_PREVIEW
	pSensorResolution->SensorFullWidth=OV5647_IMAGE_SENSOR_PV_WIDTH;
	pSensorResolution->SensorFullHeight=OV5647_IMAGE_SENSOR_PV_HEIGHT;
#else
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->PreviewDelayFrame = 0;//1; // Houston 20130917 increase pv delay frame to fix pclk phase shift
	pSensorInfo->VideoDelayFrame = 1;

	pSensorInfo->SensorMasterClockSwitch = 0; 
    pSensorInfo->SensorDrivingCurrent = ISP_DRIVING_8MA;//ISP_DRIVING_4MA;//ISP_DRIVING_6MA;//ISP_DRIVING_8MA;	// Houston 20130917 increase pv delay frame to fix pclk phase shift
...
{
	//SENSORDB("[soso][OV5647SetMaxFrameRate]u2FrameRate=%d",u2FrameRate);
	spin_lock(&ov5647_drv_lock);
