...
SP2529_write_cmos_sensor(0x14 , 0xba);//0x9a //kl_outdoor       
SP2529_write_cmos_sensor(0x15 , 0xba);//0x9a //kl_nr            
SP2529_write_cmos_sensor(0x16 , 0xab);//0x8b //kl_dummy         
SP2529_write_cmos_sensor(0x17 , 0x98);//0x88 //kl_low           
...
SP2529_write_cmos_sensor(0xfd , 0x00);        
SP2529_write_cmos_sensor(0x3f , 0x00);//0x03 //mirror/flip    
SP2529_write_cmos_sensor(0xfd , 0x01);
