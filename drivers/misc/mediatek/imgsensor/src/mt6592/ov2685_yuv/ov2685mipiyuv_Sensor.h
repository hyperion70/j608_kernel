...
typedef enum {
    ...
    SENSOR_MODE_PREVIEW,
    SENSOR_MODE_CAPTURE
} OV2685MIPI_SENSOR_MODE;

typedef enum _OV2685MIPI_OP_TYPE_ {
        OV2685MIPI_MODE_NONE,
        OV2685MIPI_MODE_PREVIEW,
        OV2685MIPI_MODE_CAPTURE,
        OV2685MIPI_MODE_QCIF_VIDEO,
        OV2685MIPI_MODE_CIF_VIDEO,
        OV2685MIPI_MODE_QVGA_VIDEO
    } OV2685MIPI_OP_TYPE;

extern OV2685MIPI_OP_TYPE OV2685MIPI_g_iOV2685MIPI_Mode;

#define OV2685MIPI_ID_REG                          (0x300A)
#define OV2685MIPI_INFO_REG                        (0x300B)
 
/* sensor size */
#define OV2685MIPI_IMAGE_SENSOR_SVGA_WIDTH          (1600) //1280
#define OV2685MIPI_IMAGE_SENSOR_SVGA_HEIGHT         (1200) //960
#define OV2685MIPI_IMAGE_SENSOR_QSXGA_WITDH         (1600)//(2592) (2590)
#define OV2685MIPI_IMAGE_SENSOR_QSXGA_HEIGHT        (1200)//(1944) (1942)
#define OV2685MIPI_IMAGE_SENSOR_VIDEO_WITDH         (1280) 
#define OV2685MIPI_IMAGE_SENSOR_VIDEO_HEIGHT        (960)

#define OV2685MIPI_IMAGE_SENSOR_720P_WIDTH          (1280)
#define OV2685MIPI_IMAGE_SENSOR_720P_HEIGHT         (720)


/* Sesnor Pixel/Line Numbers in One Period */	
#define OV2685MIPI_PV_PERIOD_PIXEL_NUMS    		(1700) //1896 	/* Default preview line length HTS*/
#define OV2685MIPI_PV_PERIOD_LINE_NUMS     		(1294)  //984 ,644	/* Default preview frame length  VTS*/
#define OV2685MIPI_FULL_PERIOD_PIXEL_NUMS  		(1700) //2844 	/* Default full size line length */
#define OV2685MIPI_FULL_PERIOD_LINE_NUMS   		(1294) //1968 	/* Default full size frame length */

/* Sensor Exposure Line Limitation */
#define OV2685MIPI_PV_EXPOSURE_LIMITATION      	(1294-4)
#define OV2685MIPI_FULL_EXPOSURE_LIMITATION    	(1294-4)

/* Config the ISP grab start x & start y, Config the ISP grab width & height */
#define OV2685MIPI_PV_GRAB_START_X 				   (0)
#define OV2685MIPI_PV_GRAB_START_Y  			(1)
#define OV2685MIPI_FULL_GRAB_START_X   			(0)
#define OV2685MIPI_FULL_GRAB_START_Y	  		(1)

/*50Hz,60Hz*/
#define OV2685MIPI_NUM_50HZ                        (50 * 2)
#define OV2685MIPI_NUM_60HZ                        (60 * 2)

/* FRAME RATE UNIT */
#define OV2685MIPI_FRAME_RATE_UNIT                 (10)

/* MAX CAMERA FRAME RATE */
#define OV2685MIPI_MAX_CAMERA_FPS                  (OV2685MIPI_FRAME_RATE_UNIT * 30)

#define OV2685_PREVIEW_MODE             0
#define OV2685_VIDEO_MODE               1
#define OV2685_PREVIEW_FULLSIZE_MODE    2


/* SENSOR READ/WRITE ID */
#define OV2685MIPI_WRITE_ID						    0x78
#define OV2685MIPI_READ_ID							0x79
