...
//	pmic_thermal_dump_reg(); // test
	...
	if((temp1>100000) || (temp1<-30000) || (temp1 > 85000))
	{
...
//Jerry 2013.3.24		pmic_thermal_dump_reg();
	...
	{
		printk("[Power/PMIC_Thermal] drop this data,pre_temp1=%d\n",pre_temp1);
		temp1 = pre_temp1;
	}
	else if( (PMIC_counter!=0) && (((pre_temp1-temp1)>30000) || ((temp1-pre_temp1)>30000)) )
	{
		printk("[Power/PMIC_Thermal] drop this data 2,pre_temp1=%d,temp1=%d\n",pre_temp1,temp1);
		temp1 = pre_temp1;
        PMIC_counter = 0;//set to zero for clear
	}
	else
	{
