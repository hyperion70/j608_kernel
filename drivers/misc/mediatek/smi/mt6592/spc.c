...
#undef pr_fmt
#define pr_fmt(fmt) "[SPC]" fmt

#define SPCMSG(string, args...)	pr_warn("[pid=%d]"string, current->tgid, ##args)
#define SPCTMP(string, args...)  pr_warn("[pid=%d]"string, current->tgid, ##args)
