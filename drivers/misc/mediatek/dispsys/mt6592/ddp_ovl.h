...
#define ADDCON_DBG_FLD_LAYER0_PIXEL_HIT                        REG_FLD(1, 14)
#define ADDCON_DBG_FLD_LAYER1_PIXEL_HIT                        REG_FLD(1, 15)
#define ADDCON_DBG_FLD_LAYER2_PIXEL_HIT                        REG_FLD(1, 30)
#define ADDCON_DBG_FLD_LAYER3_PIXEL_HIT                        REG_FLD(1, 31)
